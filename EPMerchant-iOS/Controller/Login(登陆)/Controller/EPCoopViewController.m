//
//  EPCoopViewController.m
//  EPin-IOS
//
//  Created by jeaderL on 16/4/12.
//  Copyright © 2016年 yangjx. All rights reserved.
//

#import "EPCoopViewController.h"
@interface EPCoopViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation EPCoopViewController
...
- (void)keyBoardWillShow:(NSNotification *)no{
    ...
    CGRect newTextViewFrame = CGRectMake(0,64, ScreenWidth, ScreenHeight-49-50-20);
...
- (void)keyBoardWillHide:(NSNotification *)no{
    ...
    [UIView beginAnimations:nil context:NULL];
    [UIView setAnimationDuration:animationDuration];
    self.tb.frame=CGRectMake(0,64, ScreenWidth, ScreenHeight-50-20-49);
    //提交动画
    [UIView commitAnimations];
...
- (void)postCooprationData{
    if (![EPTool validatePhone:_tfphone.text]) {
        ...
        NSDictionary * dict=[[NSDictionary alloc]initWithObjectsAndKeys:_tfName.text,@"shopName",_tfAdd.text,@"shopAddress",_lbType.text,@"shopType",_lbRange.text,@"shopRange",_tfphone.text,@"phone",_tfWechat.text,@"wechat",_tfQQ.text,@"qq", nil];
...
- (void)creatSubBtn{
    ...
    btn.backgroundColor=ColorWithRGB(29, 32, 40, 1);
    [btn setTitle:@"提交" forState:UIControlStateNormal];
    [btn setTitleColor:ColorWithRGB(216, 187, 132, 1) forState:UIControlStateNormal];
...
- (void)setTableViewHeader{
    UIImageView * img=[[UIImageView alloc]initWithFrame:CGRectMake(0,0,ScreenWidth,HEIGHT(152.0, 667))];
    ...
    foot.backgroundColor=ColorWithRGB(238, 238, 238, 1);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==2) {
        ...
        line.frame=CGRectMake(15, 0, ScreenWidth-30, 1);
        line.backgroundColor=ColorWithRGB(238, 238, 238, 1);
        [cell.contentView addSubview:line];
        UILabel * lb=[[UILabel alloc]init];
        [cell.contentView addSubview:lb];
        lb.frame=CGRectMake(15, 0, 40,25);
        lb.textColor=ColorWithRGB(51, 51, 51, 1);
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (section==1||section==4) {
        vc.backgroundColor=ColorWithRGB( 238, 238, 238, 1);
        vc.frame=CGRectMake(0, 0, ScreenWidth,8);
    }else{
        ...
        if (section==0) {
            ...
            UIView * line=[[UIView alloc]init];
            [vc addSubview:line];
            line.frame=CGRectMake(leftX, 46, ScreenWidth-30, 1);
            line.backgroundColor=ColorWithRGB( 238, 238, 238, 1);
            ...
            nameLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            ...
            addLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            //内容
            UITextField * nameTf=[[UITextField alloc]init];
            [vc addSubview:nameTf];
            nameTf.frame=CGRectMake(CGRectGetMaxX(nameLb.frame)+5,(46-30)/2 , ScreenWidth-30-70, 30);
            nameTf.font=[UIFont systemFontOfSize:15];
            nameTf.textColor=ColorWithRGB( 51, 51, 51, 1);
            _tfName=nameTf;
            UITextField * addTf=[[UITextField alloc]init];
            [vc addSubview:addTf];
            addTf.frame=CGRectMake(CGRectGetMaxX(addLb.frame)+5,(46-30)/2+46 , ScreenWidth-30-70, 30);
            addTf.font=[UIFont systemFontOfSize:15];
            addTf.textColor=ColorWithRGB( 51, 51, 51, 1);
            _tfAdd=addTf;
        }
        if (section==2) {
            ...
            typeLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            ...
            btn.x=ScreenWidth-leftX-imgSize.width;
            ...
            lb.textColor=ColorWithRGB(165, 165, 165, 1);
            lb.font=[UIFont systemFontOfSize:12];
            ...
            contentLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            if (_quan1==YES) {
                lb.text=@"已选择";
                contentLb.text=@"个体";
            }else if (_quan2==YES){
        ...
        if (section==3) {
            ...
            rangeLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            CGSize imgSize=[[UIImage imageNamed:@"下拉按钮"] size];
            UIButton * btn=[UIButton buttonWithType:UIButtonTypeCustom];
            [vc addSubview:btn];
            btn.height=46;
        ...
        if (section==5) {
            for (int i=0; i<2; i++) {
                UIView * line=[[UIView alloc]init];
                [vc addSubview:line];
                line.frame=CGRectMake(leftX, 46*(i+1), ScreenWidth-2*leftX, 1);
                line.backgroundColor=ColorWithRGB(238, 238,238, 1);
            }
            ...
            contactLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            
            UITextField * tfphone=[[UITextField alloc]init];
            [vc addSubview:tfphone];
            tfphone.frame=CGRectMake(CGRectGetMaxX(contactLb.frame)+5,(46-30)/2 , ScreenWidth-30-70, 30);
            tfphone.placeholder=@"手机号/我们会及时与您联系";
            tfphone.font=[UIFont systemFontOfSize:15];
            tfphone.textColor=ColorWithRGB( 51, 51, 51, 1);
            ...
            wechatLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            UITextField * tfWechat=[[UITextField alloc]init];
            [vc addSubview:tfWechat];
            tfWechat.frame=CGRectMake(CGRectGetMaxX(wechatLb.frame)+5,(46-30)/2+46 , ScreenWidth-30-40, 30);
            tfWechat.font=[UIFont systemFontOfSize:15];
            tfWechat.textColor=ColorWithRGB( 51, 51, 51, 1);
            ...
            QQLb.textColor=ColorWithRGB( 51, 51, 51, 1);
            UITextField * tfQQ=[[UITextField alloc]init];
            [vc addSubview:tfQQ];
            tfQQ.frame=CGRectMake(CGRectGetMaxX(QQLb.frame)+5,(46-30)/2+46*2 , ScreenWidth-30-40, 30);
            tfQQ.font=[UIFont systemFontOfSize:15];
            tfQQ.textColor=ColorWithRGB( 51, 51, 51, 1);
...
- (UITableView *)tb{
    if (!_tb) {
        _tb=[[UITableView alloc]initWithFrame:CGRectMake(0, 64, ScreenWidth, ScreenHeight-64-49) style:UITableViewStylePlain];
        _tb.delegate=self;
        _tb.dataSource=self;
