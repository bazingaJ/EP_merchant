...
- (void)viewDidLoad
{
    ...
    [self addLeftItemWithFrame:CGRectZero textOrImage:0 action:@selector(onBackClick) name:@"返回"];
}
...
//    [self.view addSubview:backBtn];
    ...
    //扫描框
    UIImageView *centerView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"scan"]];
    centerView.tag = SYCenter_Tag;
    centerView.center = self.view.center;
//    centerView.image = [UIImage imageNamed:@"scan"];
    ...
    [scanneLine setImage:[UIImage imageNamed:@"line"]];
    [self.view addSubview:scanneLine];
    
    
    UILabel *title = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(centerView.frame)+80, SYScreenWidth, 60)];
    ...
    openFlashBtn.frame = CGRectMake(CGRectGetMaxX(centerView.frame)-10, 80, 40, 40);
...
- (void)addScanneAnimation
{
    ...
    [animationMove setToValue:[NSNumber numberWithFloat:CGRectGetHeight(centerView.frame)-10.f]];
